...
def add_entries_to_split_payments_table(
    supabase, split_payment_count, client_ids, final_user_ids
):
    fake = Faker()
    main_list = []
...
def add_entries_to_payment_transactions_table(
    supabase, payment_transaction_count, split_payment_ids, client_ids, final_user_ids
):
    fake = Faker()
    main_list = []
...
def main():
    ...
    final_user_ids = add_entries_to_final_users_table(
        supabase, final_user_count, client_ids
    )
    split_payment_ids = add_entries_to_split_payments_table(
        supabase, split_payment_count, client_ids, final_user_ids
    )
    add_entries_to_payment_transactions_table(
        supabase,
